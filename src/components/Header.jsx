...
const Header = () => {
  ...
  return (
    ...
    <motion.h1 className='text-5xl max-w-[300px] sm:text-7x1 sm:max-w-[590px] mx-auto mt-10 text-center '
    initial={{opacity:0}}
    animate={{opacity:1}}
    transition={{delay:0.4 , duration:2}}
    >Transform Your Words into <span className='text-blue-600'>Stunning Visuals</span></motion.h1>
    <motion.p className='text-center max-w-xl mx-auto mt-5'
    initial={{opacity:0,y:20}}
    animate={{opacity:1,y:0}}
    transition={{delay:0.6,duration:0.8}}
    >Turn any text into visually striking images in seconds — perfect for creatives, marketers, and storytellers.</motion.p>
    ...
    >Generated images from imagenet</motion.p>
    </motion.div> 
  )}
